...
void Game1()
{
    ...
    //Depositar
    else if(LoadedObjects>0 && CSLeft_R>=204 && CSLeft_R<=235 && CSLeft_G>=186 && CSLeft_G<=163 && CSLeft_B>=0 && CSLeft_B<=0 && CSRight_R>=204 && CSRight_R<=235 && CSRight_G>=163 && CSRight_G<=186 && CSRight_B>=0 && CSRight_B<=0)
    {
        Duration = 49;
        CurAction =5;
    }
    //Norte
    else if(PositionX>=348)
    {
        Duration = 0;
        CurAction =1;
    }
