...
void Game0()
{
    ...
    else if(CSLeft_R>=204 && CSLeft_R<=244 && CSLeft_G>=158 && CSLeft_G<=198 && CSLeft_B>=0 && CSLeft_B<=20 && CSRight_R>=204 && CSRight_R<=224 && CSRight_G>=158 && CSRight_G<=198 && CSRight_B>=0 && CSRight_B<=20)
    {
        Duration = 49;
        CurAction =1;
    }
    else if(CSLeft_R>=184 && CSLeft_R<=224 && CSLeft_G>=197 && CSLeft_G<=237 && CSLeft_B>=0 && CSLeft_B<=0)
    {
        Duration = 0;
        CurAction =2;
    }
    else if(CSRight_R>=184 && CSRight_R<=224 && CSRight_G>=197 && CSRight_G<=237 && CSRight_B>=0 && CSRight_B<=0)
    {
        Duration = 0;
        CurAction =3;
    }
